...
const RequestApiKey: FC = ({}) => {
    ...
    return <div className='container md:max-w-2xl'>
        <div className='flex flex-col gap-6 items-center'>
            <Key className='mx-auto h-12 text-gray-400'/>
        ...
        <form
            ...
            <div className='relative rounded-md shadow-dm sm:min-w-0 sm:flex-1'>
                {apiKey ? (
                    <CopyButton type='button' valueToCopy={apiKey}
                                className='absolute inset-y-0 right-0 animate-in fade-in duration-300'/>) : null
                }
